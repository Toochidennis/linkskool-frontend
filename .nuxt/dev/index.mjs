...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getRequestProtocol, getRequestHost, setHeader, getQuery as getQuery$1, getHeader, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, getResponseStatusText } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve as resolve$1, dirname, join } from 'node:path';
import crypto$1 from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, withBase, parsePath, stringifyQuery, parseQuery, encodePath, stringifyParsedURL, joinRelativeURL } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/unstorage/drivers/fs.mjs';
import fsDriver from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest, hash as hash$1 } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { createConsola, consola as consola$1 } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/source-map/source-map.js';
import devalue from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { toValue, isVNode, isRef } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/vue/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/errx/dist/index.js';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2 } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/pathe/dist/index.mjs';
import { createFilter } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/nuxtseo-shared/dist/utils.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/toochidennis/Projects/linkskool-frontend/server/assets"}];
...
const _47Users_47toochidennis_47Projects_47linkskool_45frontend_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/toochidennis/Projects/linkskool-frontend","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/toochidennis/Projects/linkskool-frontend/server","watchOptions":{"ignored":[null]}}));
storage.mount('cache:nuxt:payload', _47Users_47toochidennis_47Projects_47linkskool_45frontend_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/Users/toochidennis/Projects/linkskool-frontend/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/Users/toochidennis/Projects/linkskool-frontend/.nuxt/cache/nuxt/payload"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/toochidennis/Projects/linkskool-frontend/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/toochidennis/Projects/linkskool-frontend/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/toochidennis/Projects/linkskool-frontend/.data/kv"}));
...
const _S2R623Jr8SMNfx6uGIO5y1afMBa0xmv99zRzbwKgog = (function(nitro) {
...
const _opNnvjJk7Cu9_FX69BLkbJMKWxwvhoiQy6EIUWo78 = defineNitroPlugin(async (nitroApp) => {
...
const rootDir = "/Users/toochidennis/Projects/linkskool-frontend";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"theme-color","content":"#0f172a"},{"name":"author","content":"Linkskool"},{"name":"robots","content":"index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1"},{"property":"og:site_name","content":"Linkskool"},{"property":"og:locale","content":"en_NG"},{"property":"og:image:width","content":"1200"},{"property":"og:image:height","content":"630"},{"name":"twitter:creator","content":"@linkskool"}],"link":[{"rel":"icon","href":"/favicon.ico"},{"rel":"alternate icon","href":"/favicon.ico","sizes":"any"},{"rel":"mask-icon","href":"/favicon.ico","color":"#0f172a"},{"rel":"preconnect","href":"https://fonts.googleapis.com"},{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":""},{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Inter:wght@400;600;800&family=Poppins:wght@400;600&family=Playfair+Display:wght@600;800&display=swap"}],"style":[],"script":[{"type":"application/ld+json","innerHTML":"{\"@context\":\"https://schema.org\",\"@type\":\"EducationalOrganization\",\"name\":\"Linkskool Online Ventures Limited\",\"address\":{\"@type\":\"PostalAddress\",\"addressLocality\":\"Enugu\",\"addressCountry\":\"NG\"},\"telephone\":\"+234907694303\",\"email\":\"info@linkskool.com\",\"url\":\"https://linkskool.com\",\"image\":\"https://linkskool.com/assets/og-image.png\"}"}],"noscript":[],"htmlAttrs":{"lang":"en"},"bodyAttrs":{"class":"font-inter min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300"}};
...
const _MUyOjHifWZf5Th9HlzkbFIFE2ocXlSBe9y3nA4GJPs4 = (nitroApp) => {
...
const plugins = [
  _S2R623Jr8SMNfx6uGIO5y1afMBa0xmv99zRzbwKgog,
_opNnvjJk7Cu9_FX69BLkbJMKWxwvhoiQy6EIUWo78,
_MUyOjHifWZf5Th9HlzkbFIFE2ocXlSBe9y3nA4GJPs4,
...
const _ratkX3 = eventHandler((event) => {
...
const _yNO1c1 = eventHandler(async (e) => {
  if (e.context._initedSiteConfig)
    return;
...
const _KupMvj = eventHandler(async (e) => {
...
async function parseSitemapIndex(xml) {
  ...
  const { XMLParser } = await import('file:///Users/toochidennis/Projects/linkskool-frontend/node_modules/fast-xml-parser/src/fxp.js');
...
const _SynXs6 = defineEventHandler(async (e) => {
...
const _XKcmeQ = defineEventHandler(async (e) => {
...
const _pHqBGs = defineEventHandler(async (e) => {
...
const _AxmV47 = defineEventHandler(sitemapXmlEventHandler);
...
const _lazy_1NpqpC = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _ratkX3, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_1NpqpC, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _yNO1c1, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _KupMvj, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _SynXs6, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug-production.json', handler: _XKcmeQ, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _pHqBGs, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _AxmV47, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/news', handler: _lazy_1NpqpC, lazy: true, middleware: false, method: undefined },
  { route: '/news/_payload.json', handler: _lazy_1NpqpC, lazy: true, middleware: false, method: undefined },
  { route: '/news/**', handler: _lazy_1NpqpC, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_1NpqpC, lazy: true, middleware: false, method: undefined }
];
...
const sources$1 = [
    {
        ...
        "urls": [
            {
                "loc": "/payment/completion"
            },
            {
                "loc": "/reservation/completion"
            },
            {
                "loc": "/about"
            },
