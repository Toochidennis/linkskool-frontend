import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, isRef, computed, toValue, onServerPrefetch, reactive, ref, inject, Suspense, Fragment, createApp, shallowReactive, onErrorCaptured, unref, createVNode, resolveDynamicComponent, effectScope, nextTick, toRef, defineAsyncComponent, mergeProps, getCurrentScope, isReadonly, toRaw, useSSRContext, isShallow, isReactive } from 'vue';
import { p as parseURL, e as encodePath, n as decodePath, o as hasProtocol, q as isScriptProtocol, l as joinURL, w as withQuery, r as setResponseStatus$1, t as sanitizeStatusCode, v as getContext, $ as $fetch, x as hash, h as createError$1, y as executeAsync, z as defu } from '../nitro/nitro.mjs';
...
const matcher = /* @__PURE__ */ (() => {
  const $0 = { prerender: true }, $1 = { payload: true }, $2 = { redirect: "/news" };
  return (m, p) => {
    let r = [];
...
const component_45stubGY5XhWCu6vVMJVOnXUdwjDzjLbQ2Xqf7rQPO5d243PY = {};
const _routes = [
  {
    name: "payment-completion",
    path: "/payment/completion",
    component: () => import('./completion-D_l4ObXD.mjs')
  },
  {
    name: "reservation-completion",
    path: "/reservation/completion",
    component: () => import('./completion-BSUP3iX3.mjs')
  },
  {
    name: "programs-s-enroll",
    path: "/programs/:s()/enroll",
    component: () => import('./enroll-Y3X9P7JG.mjs')
  },
  {
    name: "courses-courseId",
    path: "/courses/:courseId()",
    component: () => import('./_courseId_-DLawBA4g.mjs')
  },
  {
    name: "news-slug",
    path: "/news/:slug()",
    component: () => import('./_slug_-1egDhNcX.mjs')
  },
  {
    name: "programs-s",
    path: "/programs/:s()",
    component: () => import('./index-BbWhn3hY.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-FjkIqos3.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-B10avNIF.mjs')
  },
  {
    name: "faqs",
    path: "/faqs",
    component: () => import('./faqs-rBvic8IQ.mjs')
  },
  {
    name: "news",
    path: "/news",
    component: () => import('./index-x7y8B27M.mjs')
  },
  {
    name: "privacy-policy",
    path: "/privacy-policy",
    component: () => import('./privacy-policy-CxQZ5nOd.mjs')
  },
  {
    name: "reset-password",
    path: "/reset-password",
    component: () => import('./reset-password-BKhj_5qq.mjs')
  },
  {
    name: "terms-of-use",
    path: "/terms-of-use",
    component: () => import('./terms-of-use-C_5DGvBP.mjs')
  },
  {
    name: "notfound",
    path: "/:notfound(.*)*",
    component: () => import('./_...notfound_-HlhELcn0.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-wUykh8Ax.mjs')
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/updates",
    component: component_45stubGY5XhWCu6vVMJVOnXUdwjDzjLbQ2Xqf7rQPO5d243PY
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BXLfvEyM.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BJKE0Gg1.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useAsyncData as d, entry_default as default, encodeRoutePath as e, useRequestEvent as f, navigateTo as n, resolveRouteObject as r, setResponseStatus as s, useRouter as u };
